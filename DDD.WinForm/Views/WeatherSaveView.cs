...
{
    public partial class WeatherSaveView : Form     //WeatherSaveViewはFormを継承する
    {
        ...
        public WeatherSaveView()
        {
            ...
            this.AreaIdComboBox.DataBindings.Add(
                "SelectedValue", _viewModel, nameof(_viewModel.SelectedAreaId));        //コントロールとモデルのデータ連結。選んだ値の登録。
            this.AreaIdComboBox.DataBindings.Add(
            ...
            DateTimeTextBox.DataBindings.Add(
                "Value", _viewModel, nameof(_viewModel.DataDateValue));                 //値の登録
